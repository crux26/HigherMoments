function [SKEW, KURT, T_mmtPrice] = unit_test_main_replicating(jj)
...
T_mmtPrice = table(dates_(jj), exdate_(jj), momPrice(jj,2), momPrice(jj,3), momPrice(jj,4), r(jj), TTM(jj), ...
