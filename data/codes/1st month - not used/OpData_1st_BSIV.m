...
clear;clc;
load('rawOpData_1st.mat', 'CallData', 'PutData', 'symbol_C', 'symbol_P', 'CallBidAsk', 'PutBidAsk');
DaysPerYear = 252;
...
save('OpData_BSIV_1st.mat','CallData', 'CallIV', 'CallVolDev', 'PutData', 'PutIV', 'PutVolDev', ...
    'symbol_C', 'symbol_P', 'CallBidAsk', 'PutBidAsk');